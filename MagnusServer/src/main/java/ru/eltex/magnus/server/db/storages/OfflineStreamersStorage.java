...
public interface OfflineStreamersStorage {
     ...
     */
    List<OfflineStreamer> getAllOfflineStreamers() throws StorageException;
     ...
     */
    OfflineStreamer getOfflineStreamerByLogin(String login) throws StorageException;
     ...
     */
    boolean insertOfflineStreamer(OfflineStreamer offlineStreamer) throws StorageException;
     ...
     */
    boolean updateOfflineStreamer(OfflineStreamer offlineStreamer) throws StorageException;
     ...
     * or the offline streamer was not found
     */
    boolean removeOfflineStreamerByLogin(String login) throws StorageException;
}
